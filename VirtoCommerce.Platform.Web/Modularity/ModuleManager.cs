...
namespace VirtoCommerce.Platform.Web.Modularity
{
    ...
    public class ModuleManager : IModuleManager, IDisposable
    {
        ...
        public void LoadModule(string moduleName)
        {
            ...
            {
                throw new ModuleNotFoundException(moduleName, string.Format(CultureInfo.CurrentCulture, ModularityResources.ModuleNotFound, moduleName));
            }
        ...
        protected virtual void HandleModuleTypeLoadingError(ModuleInfo moduleInfo, Exception exception)
        {
            ...
            this.loggerFacade.Error(moduleTypeLoadingException.Message);
        ...
        private IModuleTypeLoader GetTypeLoaderForModule(ModuleInfo moduleInfo)
        {
            ...
            throw new ModuleTypeLoaderNotFoundException(moduleInfo.ModuleName, String.Format(CultureInfo.CurrentCulture, ModularityResources.NoRetrieverCanRetrieveModule, moduleInfo.ModuleName), null);
        }
